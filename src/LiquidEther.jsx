...
`;
    ...
    class Simulation {
      ...
      clear() {
        ...
        for (const target of Object.values(this.fbos)) {
    ...
    class WebGLManager {
      constructor(props) {
        ...
        this.pausedAt = null;
        this._resumeAfterPause = () => {
          if (!isVisibleRef.current || document.hidden) return;
          const now = performance.now();
          const pauseDuration = this.pausedAt == null ? 0 : now - this.pausedAt;
          this.pausedAt = null;

          Common.clock.getDelta();
          Mouse.coords_old.copy(Mouse.coords);
          Mouse.diff.set(0, 0);
          if (this.autoDriver) this.autoDriver.lastTime = now;
          if (pauseDuration > 15000) this.output?.simulation?.clear();
          this.start();
        };
        this._onVisibility = () => {
        ...
        this._onWindowFocus = () => this._resumeAfterPause();
